...
def get_columns():
    ...
    cols += [
        ...
        {
            "label": "C1b – EPF Voluntary (i-Topup)",
            "fieldname": "c1b_voluntary_epf",
            "fieldtype": "Currency",
            "options": "MYR",
            "width": 190,
        },
...
def get_data(filters=None):
    ...
    for row in base_rows:
        ...
        deductions_by_emp[emp] = {
            ...
            "c1b_voluntary_epf": _get_deduction_by_flag(slip_names, "custom_is_epf_voluntary"),
    ...
    for row in base_rows:
        ...
        c1b = emp_deductions.get("c1b_voluntary_epf", 0.0)
