"""Tests for Salary Slip XML payload builder — TDD Red Phase (UT-009).

Tests build_salary_slip_xml() and prepare_submission_wrapper() functions.
Will fail with ImportError until US-009 implements payload_builder module.
"""
import base64
import hashlib
